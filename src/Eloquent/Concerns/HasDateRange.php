...
trait HasDateRange
{
     ...
     */
    #[Scope]
    protected function whereDateRangeActive(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
     ...
     */
    #[Scope]
    protected function orWhereDateRangeActive(Builder $query, DateTimeInterface|string|null $date = null): void
    {
        $this->whereDateRangeActive($query, $date, 'or');
    }
     ...
     */
    #[Scope]
    protected function whereNotDateRangeActive(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
        $this->whereDateRangeActive($query, $date, $boolean.' not');
    }
     ...
     */
    #[Scope]
    protected function orWhereNotDateRangeActive(Builder $query, DateTimeInterface|string|null $date = null): void
    {
        $this->whereNotDateRangeActive($query, $date, 'or');
    }
     ...
     */
    #[Scope]
    protected function whereDateRangePast(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
        $date = $date ? CarbonImmutable::parse($date)->startOfDay() : CarbonImmutable::now()->startOfDay();
     ...
     */
    #[Scope]
    protected function orWhereDateRangePast(Builder $query, DateTimeInterface|string|null $date = null): void
    {
        $this->whereDateRangePast($query, $date, 'or');
    }
     ...
     */
    #[Scope]
    protected function whereNotDateRangePast(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
        $this->whereDateRangePast($query, $date, $boolean.' not');
    }
     ...
     */
    #[Scope]
    protected function orWhereNotDateRangePast(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
        $this->whereNotDateRangePast($query, $date, 'or');
    }
     ...
     */
    #[Scope]
    protected function whereDateRangeFuture(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
        $date = $date ? CarbonImmutable::parse($date)->startOfDay() : CarbonImmutable::now()->startOfDay();
     ...
     */
    #[Scope]
    protected function orWhereDateRangeFuture(Builder $query, DateTimeInterface|string|null $date = null): void
    {
        $this->whereDateRangeFuture($query, $date, 'or');
    }
     ...
     */
    #[Scope]
    protected function whereNotDateRangeFuture(Builder $query, DateTimeInterface|string|null $date = null, string $boolean = 'and'): void
    {
        $this->whereDateRangeFuture($query, $date, $boolean.' not');
    }
     ...
     */
    #[Scope]
    protected function orWhereNotDateRangeFuture(Builder $query, DateTimeInterface|string|null $date = null): void
    {
        $this->whereNotDateRangeFuture($query, $date, 'or');
    }
     ...
     */
    #[Scope]
    protected function orderByDateRangeActive(Builder $query, DateTimeInterface|string|null $date = null, string $direction = 'desc'): void
    {
        if (! in_array($direction, ['asc', 'desc'], true)) {
            throw new InvalidArgumentException('Order direction must be "asc" or "desc".');
        }
     ...
     * date. If no date is given, the current date is used.
     */
    public function isDateRangeActive(DateTimeInterface|string|null $date = null): bool
    {
     ...
     * date. If no date is given, the current date is used.
     */
    public function isNotDateRangeActive(DateTimeInterface|string|null $date = null): bool
    {
        return ! $this->isDateRangeActive($date);
    }
     ...
     * date is given, the current date is used.
     */
    public function isDateRangePast(DateTimeInterface|string|null $date = null): bool
    {
        $date = $date ? CarbonImmutable::parse($date)->startOfDay() : CarbonImmutable::now()->startOfDay();
     ...
     * date is given, the current date is used.
     */
    public function isNotDateRangePast(DateTimeInterface|string|null $date = null): bool
    {
        return ! $this->isDateRangePast($date);
    }
     ...
     * If no date is given, the current date is used.
     */
    public function isDateRangeFuture(DateTimeInterface|string|null $date = null): bool
    {
        $date = $date ? CarbonImmutable::parse($date)->startOfDay() : CarbonImmutable::now()->startOfDay();
     ...
     * If no date is given, the current date is used.
     */
    public function isNotDateRangeFuture(DateTimeInterface|string|null $date = null): bool
    {
        return ! $this->isDateRangeFuture($date);
    }
