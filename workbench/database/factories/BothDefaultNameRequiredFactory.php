...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\Workbench\App\Models\BothDefaultNameRequired>
 */
class BothDefaultNameRequiredFactory extends Factory
{
    use GeneratesDates;
    ...
    public function definition(): array
    {
        ...
        $endDate = $this->generateDateBetween($startDate, $startDate->addYear());
