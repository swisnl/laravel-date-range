...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\Workbench\App\Models\BothDefaultNameNullable>
 */
class BothDefaultNameNullableFactory extends Factory
{
    use GeneratesDates;
