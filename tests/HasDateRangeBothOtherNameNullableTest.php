...
class HasDateRangeBothOtherNameNullableTest extends TestCase
{
    ...
    public function it_can_query_active(): void
    {
        ...
        $active = BothOtherNameNullable::whereActive()->get();

        $this->assertCount(12, $active);
        $this->assertTrue($active->every(fn (BothOtherNameNullable $model) => $model->isActive()));
    }
    ...
    public function it_can_query_past(): void
    {
        ...
        $past = BothOtherNameNullable::wherePast()->get();

        $this->assertCount(12, $past);
        $this->assertTrue($past->every(fn (BothOtherNameNullable $model) => $model->isPast()));
    }
    ...
    public function it_can_query_future(): void
    {
        ...
        $future = BothOtherNameNullable::whereFuture()->get();

        $this->assertCount(12, $future);
        $this->assertTrue($future->every(fn (BothOtherNameNullable $model) => $model->isFuture()));
    }
    ...
    public function it_can_query_past_or_future(): void
    {
        ...
        $models = BothOtherNameNullable::wherePast()->orWhereFuture()->get();

        $this->assertCount(51, $models);
        $this->assertTrue($models->every(fn (BothOtherNameNullable $model) => $model->isPast() || $model->isFuture()));
    }
    ...
    public function it_can_sort_on_active(): void
    {
        ...
        /** @var \Illuminate\Support\Collection<array-key, \Workbench\App\Models\BothOtherNameNullable> $models */
        $models = BothOtherNameNullable::query()->orderByActive()->get();

        $this->assertCount(15, $models);

        $this->assertTrue($models->slice(0, 5)->every(fn (BothOtherNameNullable $model) => $model->isActive()));
        $this->assertTrue($models->slice(5)->every(fn (BothOtherNameNullable $model) => $model->isPast() || $model->isFuture()));
    }
